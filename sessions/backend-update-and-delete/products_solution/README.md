...
Lift up all logic regarding the creating of the `productData` to the `./pages/index.jsx` file.
...
Switch back to `./components/ProductForm/ProductForm` and
...
Switch to `./pages/[id].jsx` and implement a delete button:
