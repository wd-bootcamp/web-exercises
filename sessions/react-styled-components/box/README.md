...
Currently, there is a component called [`BoxWithClassName`](./components/BoxWithClassName/BoxWithClassName.jsx). This component is rendered twice in `./pages/_app.jsx`.
