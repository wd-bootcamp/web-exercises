...
Look at the `./src/App.jsx` and `./src/components/D6Button/D6Button.jsx` files.
...
- You only have to touch the `./src/App.jsx` and `./src/components/D6Button/D6Button.jsx` files.
